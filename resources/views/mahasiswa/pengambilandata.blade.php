...
<div class="card">
  ...
  <div class="container">
  <form action="{{url('save-surat-pengambilan-data')}}" method="POST">
    <div class="mb-3 mx-3">
      @csrf
      @if(session('success'))
  ...
  <div class="mb-3 mx-3">
    <label for="InputJudulSkripsi" class="form-label">Judul Skripsi</label>
    <input type="judulskripsi" class="form-control" id="InputJudulSkripsi" name="judul_skripsi">
    @foreach($errors->get('judul_skripsi') as $msg)
      <p class="text-danger font-size:2px">{{ $msg }}</p>
    @endforeach
  </div>
  <div class="mb-3 mx-3">
