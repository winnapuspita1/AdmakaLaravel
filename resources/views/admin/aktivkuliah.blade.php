                            ...
                            @endphp
                              @if ($status === "Belum Selesai")
                                <tr>
                                  ...
                                  <button type="button" class="btn btn-success" onclick="myFunction('{{url('status_surat/aktif_kuliah/'.$item['id'])}}')"> Selesai </button>
                                  </td>
                                </tr>
                              @endif
                            @endforeach
                              ...
                              @if ($status === "Selesai")
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <button type="button" onclick="myFunctionDelete('{{url('hapus_surat/aktif_kuliah/'.$item['id'])}}')" class="btn btn-danger"><i class="nav-icon fas fa-trash"></i> Delete </button>
                                  </td>
                                </tr>
                              @endif
                            @endforeach
