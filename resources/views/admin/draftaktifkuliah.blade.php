...
@section('title', 'Draft Aktif Kuliah')
@section('breadcrumb', 'Draft Aktif Kuliah')
                      ...
                      @foreach ($surat as $item)
                        @if ($item['status_surat'] === 'Selesai')
                          <tr>
                            ...
                            <td>{{ $item['nama'] }}</td>
                            <td>
                            <button onclick="window.open('{{ url( 'draft_surat/aktif_kuliah/' . $item->nama_surat) }}', '_blank')" class="btn btn-danger">PDF</button>
                            </td>
                          </tr>
                        @endif
                      @endforeach
