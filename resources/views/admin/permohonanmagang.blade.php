                          ...
                          @endphp
                            @if ($status === "Belum Selesai")
                              <tr>
                                ...
                                <a href ="{{url('status_surat/magang/'.$item['id'])}}" class="btn btn-success"> Selesai </a>
                                </td>
                              </tr>
                            @endif
                          @endforeach
                            ...
                            @if ($status === "Selesai")
                              <tr>
                                ...
                                <td>
                                  ...
                                  <a href ="{{url('hapus_surat/magang/'.$item['id'])}}" class="btn btn-danger"><i class="nav-icon fas fa-trash"></i> Delete </a>
                                </td>
                              </tr>
                            @endif
                          @endforeach
