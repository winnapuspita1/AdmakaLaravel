...
@section('title', 'Draft Permohonan Magang')
@section('breadcrumb', 'Draft Permohonan Magang')
                      ...
                      @foreach ($surat as $item)
                        @if ($item['status_surat'] === 'Selesai')
                          <tr>
                            ...
                            <td>{{ $item['nama'] }}</td>
                            <td>
                            <button onclick="window.open('{{ url( 'draft_surat/magang/' . $item->nama_surat) }}', '_blank')" class="btn btn-danger">PDF</button>
                            </td>
                          </tr>
                        @endif
                      @endforeach
