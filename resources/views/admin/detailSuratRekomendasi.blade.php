...
<div>
    <div class="card">
        <div class="p-2">
            <a class="btn btn-primary btn-sm" href="{{ url('surat_rekomendasi') }}">
      ...
      <div class="card-body">
        ...
        @endif
        <div class="p-3">
            <h5 class="mb-3">Surat Rekomendasi</h5>
            <div class="card shadow-lg p-5">
                ...
                <form action="{{url('save-surat-rekomendasi-admin')}}" method="POST"  enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
