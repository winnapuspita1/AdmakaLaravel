...
<div>
  <div class="card">
    ...
    <div class="text-end mt-4 me-4">
      <a href ="{{url('rekap_surat/transkrip')}}" class="btn btn-sm btn-primary"><i class="nav-icon fas fa-download"></i> Rekap Permohonan Surat</a>
    </div>
    <div class="card-body">
                            ...
                            @foreach ($data as $item)
                              @if (isset($item['status_surat']))
                                ...
                                @endif
                                  ...
                                  <td>
                                    <div class="dropdown">
                                      ...
                                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        ...
                                        <li>
                                              @if($item['status_surat'] === 'Selesai')
                                                  <a class="dropdown-item disabled" href="#" onclick="myFunctionTolak('{{url('tolak_surat/transkrip_nilai/'.$item['id'])}}')">Tolak</a>
                                               @else
                                                  <a class="dropdown-item" href="#" onclick="myFunctionTolak('{{url('tolak_surat/transkrip_nilai/'.$item['id'])}}')">Tolak</a>
                                               @endif
                                          </li>
                                      </ul>
                                    </div>
                                  ...
                                  <td>
                                    <a href ="{{url('detail_transkrip_nilai/'.$item['id'])}}" class="btn btn-sm btn-primary"><i class="nav-icon fas fa-eye"></i> Lihat </a>
                                    <a href ="{{url('detail_transkrip_nilai/'.$item['id'].'/true')}}" class="btn btn-sm btn-warning"><i class="nav-icon fas fa-pen"></i> Edit </a>
                                    <button type="button" onclick="myFunctionDelete('{{url('hapus_surat/transkrip_nilai/'.$item['id'])}}')" class="btn btn-sm btn-danger"><i class="nav-icon fas fa-trash"></i> Delete </button>
                                  </td>
                                </tr>
                              @endif
                            @endforeach
