...
<div>
  <div class="card">
    ...
    <div class="text-end mt-4 me-4">
      <a href ="{{url('rekap_surat/kp')}}" class="btn btn-sm btn-primary"><i class="nav-icon fas fa-download"></i> Rekap Permohonan Surat</a>
    </div>
    <div class="card-body">
                              ...
                              <td>
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a class="dropdown-item" href="#" onclick="myFunction('{{url('status_surat/kp/'.$item['id'] . '/Diterima')}}', 'Terima Permohonan Surat', 'Surat dialihkan ke bagian diterima?')">Diterima</a></li>
                                  </ul>
                                </div>
                              </td>
                            </tr>
                            ...
                            @foreach ($data as $item)
                              @if (isset($item['status_surat']))
                                ...
                                @endif
                                  ...
                                  <td>
                                    <a href ="{{url('detail_permohonan_kp/'.$item['id'])}}" class="btn btn-sm btn-primary"><i class="nav-icon fas fa-eye"></i> Lihat </a>
                                    <a href ="{{url('detail_permohonan_kp/'.$item['id'].'/true')}}" class="btn btn-sm btn-warning"><i class="nav-icon fas fa-pen"></i> Edit </a>
                                    <button type="button" onclick="myFunctionDelete('{{url('hapus_surat/kp/'.$item['id'])}}')" class="btn btn-sm btn-danger"><i class="nav-icon fas fa-trash"></i> Delete </button>
                                  </td>
                                </tr>
                              @endif
                            @endforeach
