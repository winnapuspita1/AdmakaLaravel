                          ...
                          @endphp
                            @if ($status === "Belum Selesai")
                              <tr>
                                ...
                                <td>{{ $item['nama'] }}</td>
                                <td>
                                <a href ="{{url('detail_permohonan_kp/'.$item['id'])}}" class="btn btn-primary"><i class="nav-icon fas fa-eye"></i> Lihat </a>
                                <a onclick="myFunction('{{url('status_surat/kp/'.$item['id'])}}')" class="btn btn-success"> Selesai </a>
                                </td>
                              </tr>
                            @endif
                          @endforeach
                          ...
                          @if ($status === "Selesai")
                            <tr>
                              ...
                              <td>
                                ...
                                <a href ="{{url('detail_permohonan_kp/'.$item['id'].'/true')}}" class="btn btn-warning"><i class="nav-icon fas fa-pen"></i> Edit </a>
                                <a onclick="myFunctionDelete('{{url('hapus_surat/kp/'.$item['id'])}}')" class="btn btn-danger"><i class="nav-icon fas fa-trash"></i> Delete </a>
                              </td>
                            </tr>
                          @endif
                          @endforeach
