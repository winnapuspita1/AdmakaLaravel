...
@section('title', 'Draft Transkrip Nilai Sementara')
@section('breadcrumb', 'Draft Transkrip Nilai Sementara')
                      ...
                      @foreach ($surat as $item)
                        @if ($item['status_surat'] === 'Selesai')
                          <tr>
                            ...
                            <td>{{ $item['nama'] }}</td>
                            <td>
                            <button onclick="window.open('{{ url( 'draft_surat/transkrip_nilai/' . $item->nama_surat) }}', '_blank')" class="btn btn-danger">PDF</button>
                            </td>
                          </tr>
                        @endif
                      @endforeach
