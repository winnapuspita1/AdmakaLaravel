    ...
    <div class="container shadow p-5 mb-5 rounded" style="width: 800px;">
            ...
            <div>
                <div class="d-flex flex-row mx-auto mt-3">
                    <p style="text-align: justify;text-justify: inter-word;">Adapun pelaksanaan waktu kerja praktik akan dilaksanakan mulai dari tanggal 
                        {{$fmt->format(strtotime($data[0]->tanggal_mulai))}} s.d {{$fmt->format(strtotime($data[0]->tanggal_selesai))}}. Besar harapan kami untuk dapat memberikan kesempatan serta membantu memfasilitasi mahasiswa sesuai dengan kondisi yang ada.</p>
                </div>
            </div>
