...
@section('title', 'Surat Transkrip Nilai')
@section('breadcrumb', 'Surat Transkrip Nilai')

@section('content')
<div>
    <div class="card">
        <div class="p-2">
            <a class="btn btn-primary btn-sm" href="{{ url('transkrip_nilai') }}">
      ...
      <div class="card-body">
        ...
        @endif
        <div class="p-3">
            <h5 class="mb-3">Surat Transkrip Nilai</h5>
            <div class="card shadow-lg p-5">
                ...
                <div class="row mb-3">
                    <label for="kep" class="col-sm-2">Keperluan</label>
                    <div class="col-sm-10">
                        <p id="kep">: {{strip_tags($data[0]['keperluan'])}}</p>
                    </div>
                </div>
                <form action="{{url('save-surat-transkrip-nilai-admin')}}" method="POST"  enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
