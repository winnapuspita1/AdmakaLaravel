...
@section('title', 'Surat Pengambilan Data')
@section('breadcrumb', 'Surat Pengambilan Data')

@section('content')
<div>
    <div class="card">
        <div class="p-2">
            <a class="btn btn-primary btn-sm" href="{{ url('pengambilan_data') }}">
            ...
            <div class="card shadow-lg p-5">
                ...
                <form action="{{url('save-surat-pengambilan-data-admin')}}" method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        @endif
                        <a class="btn btn-success" href="{{url('preview_draft_surat/pengambilan_data/'.$data[0]['id'])}}">Preview Draft</a>
                        <a class="btn btn-info" href="{{url('download_surat/pengambilan_data/'.$data[0]['id'].'/download')}}">Download Surat</a>
                        </div>
