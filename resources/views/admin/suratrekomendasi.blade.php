...
<div>
  <div class="card">
    ...
    <div class="text-end mt-4 me-4">
      <a href ="{{url('rekap_surat/rekomendasi')}}" class="btn btn-sm btn-primary"><i class="nav-icon fas fa-download"></i> Rekap Permohonan Surat</a>
    </div>
    <div class="card-body">
                                ...
                                <td>
                                  <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                      ...
                                      <li>
                                              @if($item['status_surat'] === 'Selesai')
                                                  <a class="dropdown-item disabled" href="#" onclick="myFunctionTolak('{{url('tolak_surat/rekomendasi/'.$item['id'])}}')">Tolak</a>
                                               @else
                                                  <a class="dropdown-item" href="#" onclick="myFunctionTolak('{{url('tolak_surat/rekomendasi/'.$item['id'])}}')">Tolak</a>
                                               @endif
                                          </li>
                                    </ul>
                                  </div>
