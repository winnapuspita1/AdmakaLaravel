                          ...
                          @endphp
                            @if ($status === "Belum Selesai")
                              <tr>
                                ...
                                <td>{{ $item['nama'] }}</td>
                                <td>
                                <a href ="{{url('detail_surat_rekomendasi/'.$item['id'])}}" class="btn btn-primary"><i class="nav-icon fas fa-eye"></i> Lihat </a>
                                <a onclick="myFunction('{{url('status_surat/rekomendasi/'.$item['id'])}}')" class="btn btn-success"> Selesai </a>
                                </td>
                              </tr>
                            @endif
                          @endforeach
                            ...
                            @if ($status === "Selesai")
                              <tr>
                                ...
                                <td>
                                  ...
                                  <a href ="{{url('detail_surat_rekomendasi/'.$item['id'].'/true')}}" class="btn btn-warning"><i class="nav-icon fas fa-pen"></i> Edit </a>
                                  <a onclick="myFunctionDelete('{{url('hapus_surat/rekomendasi/'.$item['id'])}}')" class="btn btn-danger"><i class="nav-icon fas fa-trash"></i> Delete </a>
                                </td>
                              </tr>
                            @endif
                          @endforeach
