...
<nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/aktif_kuliah_kajur" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>S.Aktif Kuliah</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/permohonan_kp_kajur" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>S.Permohonan KP</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/permohonan_magang_kajur" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>S.Permohonan Magang</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/pengambilan_data_kajur" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>S.Permohonan Pengambilan Data Penelitian</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/transkrip_nilai_kajur" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Transkrip Nilai Sementara</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/surat_rekomendasi_kajur" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>S.Rekomendasi</p>
                </a>
              </li>
            </ul>
             <!-- End of Ketua Jurusan -->

             <!-- Koordiator Kerja Praktik -->
          <li class="nav-header">KOOR KERJA PRAKTIK</li>
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-check"></i>
              <p>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/permohonan_kp_koorkerjapraktik" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>S.Permohonan KP</p>
                </a>
              </li>

              <!-- End of Koordinator Kerja Praktik -->
